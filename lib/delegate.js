...
TransliteratorWindowDelegate.prototype = {
  ...
  startKeyMappingMode: function(endPoint) {
    ...
    docEl.style.outline = "dotted 2px " + this.getService().getOptions()[Constants.BORDER_COLOR];
    docEl.style.margin  = "2px";
  ...
  decorateNode: function(node) {
    ...
    var style = "dotted 2px #39F"; //TODO get style from options
